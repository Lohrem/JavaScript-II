...
getLength(items, function(lengthOfArr) {
...
sumNums(45, 3, (total) => console.log(total));
...
multiplyNums(4, 5, (total) => console.log(total))
...
function removeDuplicates(array, cb) {
  ...
  // array.filter((cb, index) => array.indexOf(cb) === index)
}